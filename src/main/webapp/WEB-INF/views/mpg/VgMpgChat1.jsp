...
<body>
	...
	<div class="container">
		<!-- 채팅을위한 주석 -->
		<span id="chatimg" style="display: none;">${mpgdata.USR_PHOTO}</span> <span id="chatid" style="display: none;">${mpgdata.USR_ID}</span>
	...
	<script src="/resources/js/Mpgchat.js"></script>
