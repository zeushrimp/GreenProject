							...
							<div class="entries row">
								...
								<c:forEach items="${myscraprcp}" var="scrpvo">
									<div class="entry one-third">
										...
										<div class="container">
											<h2>
												<a href="/rcp/VgRcpDtail.do?RCP_PK=${scrpvo.RCP_PK}"> <c:choose>
														<c:when test="${fn:length(scrpvo.RCP_TITLE) > 12}">
															<c:out value="${fn:substring(scrpvo.RCP_TITLE,0,11)}" />.... </c:when>
														<c:otherwise>
															<c:out value="${scrpvo.RCP_TITLE}" />
														</c:otherwise>
													</c:choose>
												</a>
											</h2>
											<div class="actions">
												<div>
													<div class="difficulty">
														<i class="ico i-medium"></i><a href="#">${scrpvo.RCP_HIT}</a>
													</div>
													<div class="likes">
													...
													<div class="comments">
														<i class="fa fa-comment"></i><a
															href="VgRcpDtail.jsp#comments">${scrpvo.RCP_COM}</a>
													</div>
												</div>
											</div>
										</div>
